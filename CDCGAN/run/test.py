...
class Test():
    ...
    def set_diverse_settings(self):
        self.n_generated_images_test = 1
    ...
    def train_results(self):
        ...
        Visualization.plot_records(df[['epoch', 'disc_loss','gen_loss']], 
    ...
    def test_results(self):
        ...
        generator = FileManagement.load_trained_generator(self.path_model_ckpt_dir, self.args.n_classes, 
                                                          self.args.latent_dim, model_name='generator') 
        ...
        for i in tqdm(range(n_generated_images_test)):
            ...
            Visualization.plot_generated_images(gen_o=generator, n_classes=self.args.n_classes,
                                                    latent_dim=self.args.latent_dim,
                                                    suptitle='', save_path=save_path, 
                                                    training=False, show_title=show_title, fashion_mnist=True if self.args.dataset_name == 'fashion_mnist' else False)
            
        if n_generated_images_test > 1:
            ...
            # Remove images after combining them
