...
class Train:
    ...
    def train(self):
        ...
        ### Models
        model_ckpt_callback = SaveLoadGeneratorDiscriminatorCallback(model_list=[cdcgan_o.generator, 
                                                                               cdcgan_o.discriminator],
        ...
        # Train model
        # --------------------
        cdcgan_o.fit(dataset, epochs=self.args.epochs, initial_epoch=epoch_i, callbacks=callback_list)