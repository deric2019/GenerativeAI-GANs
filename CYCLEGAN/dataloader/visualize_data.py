...
def sample_images():
    ...
    _,_, dataset_test_A, dataset_test_B = DataLoader.load_dataset()
    ...
    # Image lists
    images_test_A = DataManagement.take_items_from_batch_dataset(dataset_test_A, nrows)
    images_test_B = DataManagement.take_items_from_batch_dataset(dataset_test_B, nrows)
...
def plot_processed_output():
    ...
    # Image lists
    images_test_A = DataManagement.take_items_from_batch_dataset(dataset_test_A, 1)
    images_test_B = DataManagement.take_items_from_batch_dataset(dataset_test_B, 1)
