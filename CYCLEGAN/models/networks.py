...
def define_resnet_generator(output_channels=3, norm_type='instancenorm', model_name=None):
...
def define_patch_discriminator(norm_type='instancenorm',use_sigmoid=False, model_name=None):
