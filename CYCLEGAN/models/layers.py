...
def down_sample(filters:int , kernel_size:tuple, strides=(2,2), padding='same',
                use_bias=True, apply_norm=True, norm_type='instancenorm', apply_relu=True, 
                relu_type='lrelu', kernel_initializer=LayerParameters.kernel_initializer):
...
def up_sample(filters: int, kernel_size: tuple, 
              strides=(2,2), padding='same',
               use_bias=True, apply_norm=True, norm_type='instancenorm',
                apply_relu=True, relu_type='relu', apply_dropout=False,
                kernel_initializer=LayerParameters.kernel_initializer):
    '''Upsamples an input, 
