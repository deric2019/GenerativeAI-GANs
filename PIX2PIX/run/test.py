...
class Test():
    ...
    def test_results():
        ...
        generator = FileManagement.load_trained_generator(model_ckpt_dir, model_name='generator') 
        ...
        for i in tqdm(range(n_generated_images_test)):
            ...
            Visualization.plot_generated_images(gen_o=generator, dataset=dataset_dict['test'],
